...
const Turnos_AprochesRoutes = (0, express_1.Router)();
...
Turnos_AprochesRoutes.post('/turn_aproches', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.default = Turnos_AprochesRoutes;
