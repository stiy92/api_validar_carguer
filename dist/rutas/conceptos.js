...
const ConceptoRoutes = (0, express_1.Router)();
...
ConceptoRoutes.post('/conceptos', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
    ...
    <soap:Body>
    <Cargar_Conceptos xmlns="http://tempuri.org/">
        ...
        const respuest = yield axios_1.default.post(url, xmlBody, {
            headers: {
                ...
                SOAPAction: 'http://tempuri.org/Cargar_Conceptos',
            },
        });
        ...
        xmlparser.parseString(respuest.data, (err, result) => {
            ...
            const informacionMovilGeneral = result['soap:Envelope']['soap:Body']['Cargar_ConceptosResponse']['Cargar_ConceptosResult']['Informacion_Movil_General'];
            if (Array.isArray(informacionMovilGeneral)) {
                ...
                informacionMovilGeneral.forEach((info) => {
                    ...
                    conceptos.push({ Codigo: codigo, Descripcion: descripcion });
                });
            }
...
exports.default = ConceptoRoutes;
