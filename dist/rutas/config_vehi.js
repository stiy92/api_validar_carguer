...
const ConfivehiRoutes = (0, express_1.Router)();
...
ConfivehiRoutes.post('/configuracion_veh', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.default = ConfivehiRoutes;
